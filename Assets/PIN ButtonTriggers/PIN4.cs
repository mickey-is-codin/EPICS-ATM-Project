...
public class PIN4 : MonoBehaviour
{
	...
	public string num4Print = "4";

	public static bool pressed4;
	...
	void OnTriggerEnter (Collider collider) //Button Pushed????
	{
		...
		if (buttonIsPressed == false) 
		{
			...
			//audio.volume = Random.Range (4.8f, 1);
			//audio.pitch = Random.Range (4.8f, 1.1f);
			audio.Play ();

			buttonCollider.isTrigger = true;
			indexTip.isTrigger = true;

			//Debug.Log ("4 Button Pushed");
