...
public class PIN8 : MonoBehaviour
{
	...
	public string num8Print = "8";

	public static bool pressed8;
	...
	void OnTriggerEnter (Collider collider) //Button Pushed????
	{
		...
		if (buttonIsPressed == false) 
		{
			...
			//audio.volume = Random.Range (8.8f, 1);
			//audio.pitch = Random.Range (8.8f, 1.1f);
			audio.Play ();

			buttonCollider.isTrigger = true;
			indexTip.isTrigger = true;

			//Debug.Log ("8 Button Pushed");
